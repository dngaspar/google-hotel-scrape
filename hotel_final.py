...
for i in range(len(ids)):  # Delete -125 if you want to scrape in one run all the row in csv
    ...
    # enter hotel name
        ...
        result = ('name entered ' + hotel_name)
        print(result)
...
df1.to_csv('final_data_reattempt_1.csv', index=False)
